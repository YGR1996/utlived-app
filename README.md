...
<img src="assets/logo.png" alt="UTLIVED" width="112" />

# UTLIVED

**自动监测主播开播 · 自动录制直播 · 弹幕压制 · 自动上传投稿 B 站**

主播一开播就自动录制，录完自动烧录弹幕、自动上传投稿到 B 站，像一台永不缺席的直播录像机。
支持 B 站、抖音、快手、虎牙、斗鱼等平台的自动录制与弹幕采集。
...
### 🌐 [官网 www.utlived.com](https://www.utlived.com/) · ⬇️ [立即下载](https://github.com/YGR1996/utlived-app/releases/latest) · 📺 [B 站主页](https://space.bilibili.com/3493131462904197)

<img src="assets/screenshot-dashboard.png" alt="UTLIVED 主界面 — 多主播自动录制" width="820" />
...
每个主播可单独配置录制 / 分割 / 自动化流水线策略：

<div align="center">
<img src="assets/screenshot-settings.png" alt="任务详情与高级策略" width="820" />
</div>

## 📥 下载

- 🌐 **官网下载（推荐，始终最新）**：[www.utlived.com](https://www.utlived.com/)
- 📦 **GitHub Releases**：[下载最新版（Windows 10/11）](https://github.com/YGR1996/utlived-app/releases/latest)

首次运行会自动安装 WebView2 运行时（若系统缺失）。
